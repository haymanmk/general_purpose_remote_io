...
> NOTE:
>
> This 3.3-volt-based signal is converted into 5 volts through the on-board [SN74LVC1T45](https://www.ti.com/lit/ds/symlink/sn74lvc1t45.pdf?ts=1765115086705&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FSN74LVC1T45%252Fpart-details%252FSN74LVC1T45DBVR%253Futm_source%253Dgoogle%2526utm_medium%253Dcpc%2526utm_campaign%253Dasc-null-null-asc_opn_en-cpc-storeic-google-in_en_pur%2526utm_content%253DDevice%2526ds_k%253DSN74LVC1T45DBVR%2526DCM%253Dyes%2526gclsrc%253Daw.ds%2526gad_source%253D1%2526gad_campaignid%253D22842882905%2526gbraid%253D0AAAAAC068F2cxZwRS_JfXQ0bWIbiGo0nu%2526gclid%253DCj0KCQiA6NTJBhDEARIsAB7QHD2yCAlis5sK2ltOpZl7pd5V-LTxWguk3-9M95WaM_gsb5MZ72xBjZoaAj1zEALw_wcB) chip. Unfortunately, someone's design powered this chip with the 3.3v power on the  I/O board instead of using the 3.3v power from STM32F7. This is obviously a totally wrong design (so ridiculous). The syndrome of double power references is that the signal at 3.3v-based PWM port becomes unstable even it is at idle mode. In order to address this issue, there is a workaround which is by enabling the pull-down resistor at the PWM port. After doing so, the signal ends up becoming stabilized and insensitive to noise.
