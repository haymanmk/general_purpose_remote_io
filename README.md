...
| 109.x | Flow control | Configure the serial flow control for channel `x`. | `R109`: read flow control setting. <br> The return would be either `R109 0` means without flow control or `R109 1` means with flow control. <br> `W109 1`: enable flow control, and vice versa. | R/W/A/F |
...
| :----- | :----------- | :---------- |
| 00 | PA1 | Digital Input |
| 01 | PA2 | Digital Input |
| 100 | PE1 | Analog Input |
| 101 | PE2 | Analog Input |

## Output Mapping
| Pin ID | STM32 Pin ID | Description |
| :----- | :----------- | :---------- |
| 50 | PB1 | Digital Output |
| 51 | PB2 | Digital Output |
| 150 | PD1 | Analog Output |
| 151 | PD2 | Analog Output |
